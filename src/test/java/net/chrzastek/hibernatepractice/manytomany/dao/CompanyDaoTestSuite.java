...
public class CompanyDaoTestSuite {
  ...
  public void testQueries() {
    ...
    //When
    List<Employee> employeesByGivenLastname = employeeDao.retrieveEmployeesWithGivenName("Smith");
    List<Company> companiesByGivenNameSigns = companyDao.retrieveCompaniesWithGivenName("Sof%");
